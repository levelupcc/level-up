...
- Ask participants to take a picture with their phones and to check all the metadata that the image file contains - you will need to provide them with a tool such as CameraV to do this, or you may also share a web-based tool like http://metapicz.com or [Metadata Remover's Metadata Viewer](https://metadataremover.ai/metadata-viewer), which reads common EXIF, IPTC, XMP, and GPS fields in the browser. Remind participants that metadata can be altered and should be corroborated with other evidence.
