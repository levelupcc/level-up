...
You have the specific **themes** within the larger context. For Digital Security, this could be [Safer Communication](/level-up/curriculum/safer-communication/), [Protecting Data](/level-up/curriculum/protecting-data/), [Malware Protection](level-up/curriculum/malware-protection/) and so forth. Another way of looking at these is to think of them as the *reasons* that training is required - what are participants trying to protect themselves from or improve?

##### At the third level tier... 
You have the individual **Topics**, which are the specific tools or practices that will need to be covered in order to address the **Themes** of the event's content. These could be [Creating and Managing Strong Passwords](/level-up/curriculum/protecting-data/creating-and-managing-strong-passwords/), using [PGP/GPG Email Encryption](/level-up/curriculum/safer-communication/pgp-gpg-email-encryption/), or how to browse more safely using browsers for [Anonymity and Circumvention](/level-up/curriculum/safer-browsing/anonymity-and-circumvention/).
...
For a sample, please visit our [Trainers' Curriculum](level-up/curriculum/), or <a href="/level-up/assets/files/LU_session_planning_template-SAMPLE.odt">download our sample planning template.</a>
<br><br>
...
The assumption behind [LevelUp's Approach to Adult Learning](/level-up/before-an-event/levelups-approach-to-adult-learning/) is that learning and awareness-raising happens in *stages*, and we cannot expect a person to learn everything about an issue in one go, or in one lecture. 
