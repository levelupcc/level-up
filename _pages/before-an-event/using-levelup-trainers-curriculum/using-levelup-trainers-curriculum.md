...
weight: 3.1
---
##### This How-To resource explains the mechanics of how [LevelUp's Trainers' Curriculum](/level-up/curriculum/) is structured, and considerations for using it to design your events.
...
[Safer Browsing - Identity Protection and Privacy](/level-up/curriculum/safer-browsing/anonymity-and-circumvention/) covers both Tor Browser and HTTPS Everywhere, and has distinct **Deepening** elements for each.

[Safer Workspaces - Tails](/level-up/curriculum/safer-workspaces/tails/) features distinct **Inputs** that trainers can use one or more of, depending on the context Tails will be trained in; it also has separate **Deepening** elements for different use cases of Tails.
...
Refer to [Developing a Shared Brain](/level-up/you-the-trainer/first-3-sessions-of-your-event/developing-a-shared-brain/) under [The First 3 Sessions of Your Event](/level-up/you-the-trainer/first-3-sessions-of-your-event/) for a practical guide on how to establish and manage a "parking lot" or "bike rack" for questions that come up during your event - this is a great tool for time management that helps keep your sessions on track and on time.
<br><br>
...
That being said, make sure you don’t skip over the most fundamental topics that you will continue to build upon throughout the workshop, and avoid sequencing sessions in a way that may cause larger problems down the road. For example, with many groups, three vital things to cover towards the *beginning* of a digital safety training are [Using Antivirus Tools](/level-up/curriculum/malware-protection/using-antivirus-tools/), [Data Backup Basics](/level-up/curriculum/protecting-data/data-backup-basics/) and [Creating and Managing Strong Passwords](/level-up/curriculum/protecting-data/creating-and-managing-strong-passwords/).

#### Here are 3 reasons why:

[Using Antivirus Tools](/level-up/curriculum/malware-protection/using-antivirus-tools/)
...
[Data Backup Basics](/level-up/curriculum/protecting-data/data-backup-basics/)
...
[Creating and Managing Strong Passwords](/level-up/curriculum/protecting-data/creating-and-managing-strong-passwords/)
